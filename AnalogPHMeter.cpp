...
void AnalogPHMeter::putPHCalibrationValue(unsigned char* calibrationVal, unsigned int size) {
  unsigned char* pBuffer = (unsigned char*)&calibrationValue;
  for (size_t i = 0; i < size; i++) {
    *pBuffer = *calibrationVal;
    pBuffer++;
    calibrationVal++;
  }
}
